...
class SimpleTestLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        import senaite.api
        import senaite.samplepointlocations
        ...
        self.loadZCML(package=senaite.samplepointlocations)
        ...
        zope.installProduct(app, "senaite.samplepointlocations")

    def setUpPloneSite(self, portal):
        super(SimpleTestLayer, self).setUpPloneSite(portal)
        applyProfile(portal, "senaite.core:default")
        applyProfile(portal, "senaite.samplepointlocations:default")
        transaction.commit()
...
SIMPLE_TESTING = FunctionalTesting(
    bases=(SIMPLE_FIXTURE,), name="senaite.samplepointlocations:SimpleTesting"
)
